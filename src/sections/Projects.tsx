...
export const ProjectsSection = () => {
  return (
    <section className="pb-16 lg:py-24 pt-12">
      <div className="container">
        <SectionHeader title="Projects" subtitle="Portfolio" text="A selection of my work" />
            ...
            >
              ...
              <ul className="flex flex-col gap-4 mt-4 md:mt-5">
                {project.results.map((result, index) => (
                  <li key={index} className="flex gap-2 text-sm md:text-base text-white/80">
              ...
              <div className="flex justify-center mt-8 -mb-4 md:-mb-0 lg:mt-0 lg:ml-72 relative"><Image src={project.image} alt={project.title} className="lg:absolute lg:h-full lg:w-auto lg:max-w-none"/></div>
              </div>
            </Card>
          ))}
        </div>
